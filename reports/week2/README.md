...
Tickframe MVP v0 is a static desktop web foundation for demonstrating cryptocurrency pattern analytics, navigation, and user-scoped mock alerts.


This project is licensed under the MIT License(licence located in the root)
...
All screenshots in the folder images, which is located in current folder
