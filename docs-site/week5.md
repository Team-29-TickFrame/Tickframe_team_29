...
This page collects public Assignment 5 / Week 5 documentation entry points.
Private Moodle-only materials, private recordings, credentials, exact private
timecodes, university emails, and customer-identifying details are intentionally
excluded.
...
When the MVP v2 SemVer release is published, add this hosted documentation site
URL to the release notes so reviewers can reach the maintained docs without
starting from raw repository file browsing.
