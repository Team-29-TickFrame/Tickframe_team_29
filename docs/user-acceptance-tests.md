...
This document maintains end-user-facing UAT scenarios for Assignment 4. The scenarios are intended to be executed with the customer during the Week 4 customer session.
...
The Week 4 UAT was conducted during the recorded customer session on 2026-06-27. The team guided the customer through the scenarios by operating the product during the call, while the customer/stakeholder confirmed the flows and approved the demonstrated behavior.
...
|---|---|---|---|
| UAT-001 | Passed | The main Tickframe Analytics dashboard opened successfully and was understandable during the demonstration. | No follow-up required from this UAT scenario |
| UAT-002 | Passed | Market data, chart output, ML pattern panel, and metric events were demonstrated successfully. The customer/stakeholder approved the flow. | No follow-up required from this UAT scenario |
| UAT-003 | Passed | Real-time data availability was clear through live exchange values, data age/status indicators, and venue delta. The customer/stakeholder approved the flow. | No follow-up required from this UAT scenario |
